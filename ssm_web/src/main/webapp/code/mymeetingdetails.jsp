                ...
                <form>
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>会议名称：</td>
                                <td>${myMeetingDetails.meetingname}</td>
                            </tr>
                            <tr>
                                <td>预计参加人数：</td>
                                <td>${myMeetingDetails.numberofparticipants}</td>
                            </tr>
                            <tr>
                                <td>预计开始时间：</td>
                                <td>${myMeetingDetails.strstarttime}</td>
                            </tr>
                            <tr>
                                <td>预计结束时间：</td>
                                <td>${myMeetingDetails.strendtime}
                                </td>
                            </tr>
                            <tr>
                                <td>会议说明：</td>
                                <td>
                                    <textarea id="description" rows="5" readonly>${myMeetingDetails.description}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>参会人员：</td>
                                <td>
                                    <table class="listtable">
                                        ...
                                        <c:forEach items="${myMeetingDetails.employees}" var="employee">
                                        <tr>
                            ...
                            <tr>
                                <td class="command" colspan="2">
                                    <input type="button" class="clickbutton" value="撤销会议" onclick="window.location.href='${pageContext.request.contextPath}/metting/revoke?meetingid=${myMeetingDetails.meetingid}';"/>
