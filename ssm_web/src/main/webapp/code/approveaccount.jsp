        ...
        <table class="listtable">
            ...
            <c:forEach items="${employees}" var="employees">
                <tr>
                    ...
                    <td>j${employees.email}</td>
                    <td>
                        <input type="button" class="clickbutton" value="通过" onclick="location.href='${pageContext.request.contextPath}/emp/approveaccount/pass?employeeid=${employees.employeeid}'" />
                        <input type="button" class="clickbutton" value="删除" onclick="location.href='${pageContext.request.contextPath}/emp/approveaccount/delete?employeeid=${employees.employeeid}'"/>
                    </td>
                </tr>
            </c:forEach>
        </table>
