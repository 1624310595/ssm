        ...
        <form>
            <fieldset>
                ...
                <table class="formtable">
                    <tr>
                        <td>会议名称：</td>
                        <td>${details.meetingname}</td>
                    </tr>
                    <tr>
                        <td>预计参加人数：</td>
                        <td>${details.numberofparticipants}</td>
                    </tr>
                    <tr>
                        <td>预计开始时间：</td>
                        <td>${details.strstarttime}</td>
                    </tr>
                    <tr>
                        <td>预计结束时间：</td>
                        <td>${details.strendtime}
                        </td>
                    </tr>
                    <tr>
                        <td>会议说明：</td>
                        <td>
                            <textarea id="description" rows="5" readonly>${details.description}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>参会人员：</td>
                        <td>
                            <table class="listtable">
                                ...
                                <c:forEach items="${details.employees}" var="employee">
                                    <tr>
