            ...
            <div class="page-content">
                ...
                <table class="listtable">
                    ...
                    <tr>
                        ...
                        <td>${mymeeting.meetingroom.roomname}</td>
                        <td>${mymeeting.strstarttime}</td>
                        <td>${mymeeting.strendtime}</td>
                        <td>${mymeeting.strreservationtime}</td>
                        <td>${username}</td>
                        <td>
                            <a class="clickbutton" href="${pageContext.request.contextPath}/metting/myDetails?meetingid=${mymeeting.meetingid}">查看详情</a>
                        </td>
                    </tr>
                    </c:forEach>
                </table>
